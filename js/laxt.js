...
$(function() {
    ...
    $("form#form").on("submit", function() {
        ...
        if ($(".requiredField").each(function() {
                if ("" === jQuery.trim($(this).val())) $(this).prev("label").text(), $(this).parent().append('<span class="error">Обязательное поле</span>'), $(this).addClass(
                    "inputError"), s = !0;
            ...
            $.post($(this).attr("action"),{typeAction: $(this).attr("typeAction"),name: $(this).find( "input[name='name']" ).val(), phone: $(this).find( "input[name='phone']" ).val()} , function() {  // r
                $("form#form").slideUp("fast", function() {
                    $(this).before('<div class="success">Мы скоро свяжимся с вами</div>');
                });
            });
        }
        return !1;
        ...
        if ($(".subscribe-requiredField").each(function() {
            ...
            $.post($(this).attr("action"), r, function() {
                $("form#subscribe").slideUp("fast", function() {
                    $(this).before('<div class="subscribe-success">Мы подготовим и пришлем в ближайшее время потрясающее предложение для вас!</div>');
                });
            });
        }
        return !1;
